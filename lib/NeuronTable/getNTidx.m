...
%
%   This function works the same as getTDidx, but for neuronTable structure.
%   Below is the help for getTDidx:
%
...
neuronTable = neuronTable(return_idx,:);
